...
//
//go:generate mkdir -p github.com/glin-gogogo/boxo/bitswap/message/pb
//go:generate ln -f message.proto github.com/glin-gogogo/boxo/bitswap/message/pb
//go:generate protoc --go_out=. github.com/glin-gogogo/boxo/bitswap/message//pb/message.proto
//go:generate mv -f github.com/glin-gogogo/boxo/bitswap/message//pb/message.pb.go .
